...
object Blocks {
    ...
    val ELECTRIC_BREWING_STAND = registerTileEntity(MACHINES, "electric_brewing_stand", STONE, ::ElectricBrewingStand, listOf(EnergyHolder::modifyItemBuilder, NovaFluidHolder::modifyItemBuilder))
    val PUMP = registerTileEntity(MACHINES, "pump", STONE, ::Pump, listOf(EnergyHolder::modifyItemBuilder, NovaFluidHolder::modifyItemBuilder))
    val FREEZER = registerTileEntity(MACHINES, "freezer", STONE, ::Freezer, listOf(EnergyHolder::modifyItemBuilder, NovaFluidHolder::modifyItemBuilder))
    val FLUID_INFUSER = registerTileEntity(MACHINES, "fluid_infuser", STONE, ::FluidInfuser, listOf(EnergyHolder::modifyItemBuilder, NovaFluidHolder::modifyItemBuilder))
    ...
    val LAVA_GENERATOR = registerTileEntity(MACHINES, "lava_generator", STONE, ::LavaGenerator, listOf(EnergyHolder::modifyItemBuilder, NovaFluidHolder::modifyItemBuilder))
