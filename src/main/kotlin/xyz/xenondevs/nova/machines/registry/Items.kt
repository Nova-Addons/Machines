...
object Items {
    ...
    // Armor
    val STAR_HELMET = registerItem(Machines, "star_helmet", Wearable(ArmorType.HELMET, Sounds.ARMOR_EQUIP_STAR), Damageable)
    val STAR_CHESTPLATE = registerItem(Machines, "star_chestplate", Wearable(ArmorType.CHESTPLATE, Sounds.ARMOR_EQUIP_STAR), Damageable)
    val STAR_LEGGINGS = registerItem(Machines, "star_leggings", Wearable(ArmorType.LEGGINGS, Sounds.ARMOR_EQUIP_STAR), Damageable)
    val STAR_BOOTS = registerItem(Machines, "star_boots", Wearable(ArmorType.BOOTS, Sounds.ARMOR_EQUIP_STAR), Damageable)
